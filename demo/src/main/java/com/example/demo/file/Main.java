...
public class Main {
    ...
    public static void main(String[] args) {
        BigFileReader.Builder builder = new BigFileReader.Builder("C:/Users/chuang/Desktop/test.txt", new IHandle() {

            @Override
            public void handle(String line) {

				File file = new File("C:/Users/chuang/Desktop/test2.txt");
